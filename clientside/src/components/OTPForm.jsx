...
const OTPFORM = ({ isOtpModal, modalOtpClose, setModalOpen }) => {
  ...
  const onSubmitHandler = (data) => {
    ...
    if (forgetPasswordResponse.OTP === otp) {
      ...
      toast.success("OTP Matches successfull kindly reset password", {
  ...
  return (
    <>
      <div
        id="modal-body"
        onClick={(e) => e.target.id === "modal-body"}
        ...
        <div className="w-[28rem] bg-white rounded-md px-6 py-8">
          <div className="flex flex-col items-center justify-center text-center space-y-2">
            ...
            <div className="flex flex-row text-sm font-medium text-gray-400">
              <p>
                We have sent a code to your email {forgetPasswordResponse.email}
              </p>
            </div>
          </div>
          <div>
